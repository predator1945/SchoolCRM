...
import { updateClassroom, updateNameField } from './classrooms.actions';
...
class ClassroomNew extends Component {
    ...
    onSubmit() {
        this.props.updateClassroom(this.props.match.params.id, {name: this.props.name}, ()=> this.props.history.push("/classrooms"));
...
function mapStateToProps(state) {
    return {
        ...
        id: state.classrooms.id
    }
}

export default connect(mapStateToProps, { updateClassroom, updateNameField })(ClassroomNew);

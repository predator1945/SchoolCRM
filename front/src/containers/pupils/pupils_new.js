...
import { createPupil, updateCardField, updateFNameField, updateLNameField, updatePeselField } from './pupils.actions';
...
export default connect(mapStateToProps, { createPupil, updateCardField, updateFNameField, updateLNameField, updatePeselField })(SubjectsNew);

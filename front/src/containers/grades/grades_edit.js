...
import { updateGrade, updateDateField, updatePupilField, updateSubjectField, updateGradeField } from './grades.actions';
...
class SubjectsNew extends Component {
    ...
    onSubmit() {
        ...
        console.log(date);
        this.props.updateGrade(this.props.match.params.id, {
...
export default connect(mapStateToProps, { 
    ...
    updateGrade, updateDateField, updatePupilField, updateSubjectField, updateGradeField })(SubjectsNew);

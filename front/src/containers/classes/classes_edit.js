...
import { updateClass, updateDateField, updateNameField, updateTeacherField } from './classes.actions';
...
class SubjectsNew extends Component {
    ...
    onSubmit() {
        ...
        console.log(date);
        this.props.updateClass(this.props.match.params.id, {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <button className="btn btn-info" onClick={() => this.onSubmit()} > Edit</button>
...
export default connect(mapStateToProps, { updateClass, updateDateField, updateNameField, updateTeacherField, fetchTeachers })(SubjectsNew);

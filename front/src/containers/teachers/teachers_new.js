...
import { createTeacher, updateFNameField, updateLNameField, updatePeselField } from './teachers.actions';
...
export default connect(mapStateToProps, { createTeacher, updateFNameField,  updatePeselField,   updateLNameField })(SubjectsNew);
